...
class PassReset(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.Label1.configure(text='Vul nieuwe code in')
        ...
        self.Button1.configure(command=lambda: self.setPass())
    ...
    def setPass(self):
        ...
        with open('password.txt', 'w') as f:
            ...
            f.write(digitString)
            f.close()
        self.controller.passkey = digitString
